...
SAMPLE="/afs/cern.ch/user/r/richard/CMSSW_5_3_6_patch1/src/crab_0_121207_204510/res/*.stdout"
...
do
    ...
    grep "TrigReport ---------- Path   Summary ------------" $SAMPLE -A 120 | grep $triggername  >& tempLog.txt
